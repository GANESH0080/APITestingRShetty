...
public class Basics {
	...
	public static void main(String[] args) {
		// Validate If ADD_PLACE API working properly
		...
		String getAPI = given().log().all().param("key", "qaclick123").queryParam("place_id", placeID).when().get("maps/api/place/get/json").then().log()
		.all().assertThat().statusCode(200).body("address", equalTo(address)).extract().response().asString();
